...
const styles = StyleSheet.create({
  ...
  addressText: { fontSize: 16, color: '#14532d', lineHeight: 22 },
  ...
  totalValue: { fontSize: 16, fontWeight: 'bold', color: '#15803d' },
  ...
  dangerOutlineText: { color: '#dc2626', fontSize: 15, fontWeight: '600' },
  amberButton: {
  ...
  amberButtonText: { color: '#92400e', fontSize: 15, fontWeight: '600' },
  outlineButton: {
    backgroundColor: '#f0fdf4',
    borderRadius: 8,
    padding: 14,
  ...
  outlineButtonText: { color: '#15803d', fontSize: 15, fontWeight: '600' },
  reasonBox: {
    backgroundColor: '#fff',
    borderRadius: 8,
    padding: 14,
  ...
  reasonTitle: { fontSize: 15, fontWeight: '700', color: '#b91c1c' },
  ...
  presetChipText: { color: '#b91c1c', fontSize: 13, fontWeight: '600' },
  reasonInput: {
    borderWidth: 1,
    borderColor: '#ccc',
    borderRadius: 8,
